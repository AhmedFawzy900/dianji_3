...
Route::group(['middleware' => ['auth', 'verified']], function()
{
    ...
    // add app ui pages here
    Route::get('app-slider', [AppUiController::class, 'slider_index'])->name('app.slider.index');
    Route::get('app-slider-create', [AppUiController::class, 'slider_create'])->name('app.slider.create');
    Route::get('app-slider-edit/{id}', [AppUiController::class, 'slider_edit'])->name('app.slider.edit');
    Route::post('app-slider-update/{id}', [AppUiController::class, 'slider_update'])->name('app.slider.update');
    Route::post('app-slider-store', [AppUiController::class, 'slider_store'])->name('app.slider.store');
    Route::delete('app-slider-delete/{id}', [AppUiController::class, 'slider_destroy'])->name('app.slider.delete');
    // add app ui videos here
    Route::get('app-videos', [AppUiController::class, 'videos_index'])->name('app.videos.index');
    Route::get('app-videos-create', [AppUiController::class, 'videos_create'])->name('app.videos.create');
    Route::get('app-videos-edit/{id}', [AppUiController::class, 'videos_edit'])->name('app.videos.edit');
    Route::post('app-videos-update/{id}', [AppUiController::class, 'videos_update'])->name('app.videos.update');
    Route::post('app-videos-store', [AppUiController::class, 'videos_store'])->name('app.videos.store');
    Route::delete('app-videos-delete/{id}', [AppUiController::class, 'videos_destroy'])->name('app.videos.delete');
