<x-master-layout>
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                {{ Form::select('parent_id', 
                                    [null => __('اختر القسم الرئيسي')] + $categories->pluck('name', 'id')->toArray(),
                                    old('parent_id', $categorydata->parent_id),
                                    [
            ...
            {{-- add tree --}}
            <div class="col-md-4">
                @include('components.category-tree', ['categories' => $categories_tree])
            </div>
            {{-- end tree --}}
        </div>
