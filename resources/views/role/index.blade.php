      ...
      <div class="card-body">
        <div class="row justify-content-between">
          <div>
            ...
            <!-- <div class="col-md-12">
                  <form action="{{ route('role.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('role.bulk-action') }}"
                data-datatable="reload" data-confirmation='true'
                data-title="{{ __('role',['form'=>  __('role') ]) }}"
